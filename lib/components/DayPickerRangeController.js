...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  onKeyDownEscape: _propTypes["default"].func,
...
var DayPickerRangeController = /*#__PURE__*/function (_ref) {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var _this$props = this.props,
        ...
        prevMaxDate = _this$props.maxDate,
        prevMinDate = _this$props.minDate;
    ...
    if (maxDate !== prevMaxDate) {
      ...
      this.setState({
        disableNext: this.shouldDisableMonthNavigation(maxDate, _currentMonth)
      });
    }

    if (minDate !== prevMinDate) {
      var _currentMonth2 = this.state.currentMonth;
      this.setState({
        disablePrev: this.shouldDisableMonthNavigation(minDate, _currentMonth2)
      });
    }
  };
